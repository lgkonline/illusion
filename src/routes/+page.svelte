...
<div class="container-fluid">
    <main style={`padding-left: ${padding}px; padding-right: ${padding}px`}>
        {#if currentArrowCard !== undefined && currentColorCard !== undefined}
            <div class="row">
                <div class="col">
                    <div class="sticky-top d-flex flex-column" style="min-height: 100vh;">
        ...
        {:else}
            <div class="text-center">
                ...
                <div>
                    <a href="https://github.com/lgkonline/illusion" target="_blank" rel="noopener noreferrer">GitHub</a>
                    <a href="https://lgk.io" target="_blank" rel="noopener noreferrer">LGK</a>
                </div>
            </div>
        {/if}
    </main>
